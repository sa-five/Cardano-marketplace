    ...
    const [complexTransaction, setComplexTransaction] = useState(
        {
            ...
            [
                {
                    address:"addr_test1qrgdtzs4922matfqtzh4vfnffm50wrehc77m0pst65tvapzfhec45efhlmtczlzkylnpkc7mxj0ar0dnd2xts2vleujsgvlww7", 
                    amount: "3", 
                    mintedAssets:
                    [
                        {
                ...
                <div className="row" >
                    ...
                    <div className="item address">
                        ...
                        <div className="item address"><p> Recipients Input</p><textarea style={{ width: "400px", height: "500px", }}
                            value={
                                JSON.stringify(complexTransaction)
                            }
                            onChange={(event) => 
                                {
